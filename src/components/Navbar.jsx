...
const navLinkClass = ({ isActive }) =>
  [
    'text-base font-semibold uppercase tracking-[0.3em] transition-colors',
...
function Navbar() {
  ...
  return (
    <header className="relative overflow-visible border-b border-white/10">
      <div className="mx-auto flex w-full max-w-6xl items-center justify-between px-4 py-4 md:px-6 md:py-5">
        ...
        <div className="hidden items-center gap-3 md:flex">
          ...
          <button
            type="button"
            onClick={handleShare}
            className="min-h-[48px] rounded-full bg-fuchsia-300/90 px-4 py-2 text-base font-semibold uppercase tracking-[0.2em] text-zinc-950 transition hover:bg-fuchsia-200 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-fuchsia-200"
          >
            Share
          </button>
          {shareStatus ? (
        ...
        <div className="flex items-center md:hidden">
          <button
            ...
            className="min-h-[48px] rounded-full border border-white/20 px-4 py-2 text-sm font-semibold uppercase tracking-[0.2em] text-white transition hover:border-fuchsia-300 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-fuchsia-300"
      ...
      <img
        src={assIndexLogo}
        alt="The Ass Index"
        className="absolute left-4 top-[calc(50%+10px)] z-20 h-[140px] w-[140px] -translate-y-1/2 object-contain md:left-6 md:top-[calc(50%+15px)] md:h-[210px] md:w-[210px]"
      />
      <div
